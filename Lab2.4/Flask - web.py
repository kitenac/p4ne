...
import sys
from backend import get_Info, API_get_info
...
def index():
    ...
    return render_template('index.html', payload=payload, urls=urls, lab_urls=lab_urls, API_info=API_info)
